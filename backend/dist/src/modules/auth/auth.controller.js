...
let AuthController = class AuthController {
    ...
    async logout(userId, tenantId, authHeader, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Autenticar usuário e obter tokens JWT' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Muitas tentativas — rate limit ativo' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Encerrar sessão e revogar tokens' }),
