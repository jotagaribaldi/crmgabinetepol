...
export declare class RegionsService {
    ...
    addMunicipalities(id: string, municipalityIds: string[], actor: {
        id: string;
        role: Role;
        tenantId: string | null;
    }): Promise<{
    ...
    removeMunicipalities(id: string, municipalityIds: string[], actor: {
        id: string;
        role: Role;
        tenantId: string | null;
    }): Promise<{
    ...
    assignCoordinator(id: string, coordinatorId: string | null, actor: {
        id: string;
        role: Role;
        tenantId: string | null;
    }): Promise<{
    ...
    private validateMunicipalities;
    private auditLog;
}
